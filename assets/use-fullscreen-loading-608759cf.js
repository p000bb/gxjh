/* empty css             */import{E as m}from"./el-button-b054d70c.js";import{v as n,L as i}from"./directive-a7cdde23.js";import{G as c}from"./user-9279ed61.js";import{d as g,y as _,A as f,k as l,B as d,ag as u,E as y}from"./viewer-a917d3a0.js";import"./use-form-item-a2dc758c.js";import"./use-form-common-props-957cc35c.js";import"./index-9899f039.js";const E={install(e){e.directive("loading",n),e.config.globalProperties.$loading=i},directive:n,service:i},h={lock:!0,text:"加载中..."},p=(e,t={})=>{let o;return async(...r)=>{try{return o=E.service({...h,...t}),await e(...r)}finally{o==null||o.close()}}},k={code:0,data:{list:[]},message:"获取成功"};function v(e){return new Promise(t=>{setTimeout(()=>{t({...k,data:{list:e}})},1e3)})}function w(){return new Promise((e,t)=>{setTimeout(()=>{t(new Error("发生错误"))},1e3)})}const x={class:"app-container"},C=y("h4",null,"该示例是演示：通过将要执行的函数传递给 hook，让 hook 自动开启全屏 loading，函数执行结束后自动关闭 loading",-1),S=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
