...
.logo-icon {
  @apply text-[18rem] absolute max-xl:text-[14rem] max-lg:text-[12rem] max-md:text-[10rem] max-sm:text-[8rem];
}

.logo-icon-a {
  @apply text-[15rem] absolute max-xl:text-[12rem] max-lg:text-[10rem] max-md:text-[8rem] max-sm:text-[6rem];
}
</style>
