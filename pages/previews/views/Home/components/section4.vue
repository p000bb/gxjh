        ...
        <div class="grid gap-0 grid-cols-10 max-lg:grid-cols-1">
          <div class="col-span-3 text-black flex justify-between flex-col max-lg:col-span-1">
            <div data-aos="fade-right">
              <h1 class="text-6xl font-black -translate-y-10 leading-[4.5rem] tracking-widest mb-8">
                用影像， <br />见证岁月
              </h1>
              <el-button type="danger" round size="large" class="button">{{ $t("home.find") }}</el-button>
            </div>
