      ...
      <div class="grid grid-cols-1 gap-10">
        <div class="grid gap-0 grid-cols-10 max-lg:grid-cols-1">
          <div class="col-span-3 text-black flex justify-between flex-col max-lg:col-span-1">
            <div data-aos="fade-right">
              <h1 class="text-6xl -translate-y-10 leading-[4.5rem] tracking-widest mb-8 font-gxjh-bold">
                用影像， <br />见证岁月
              </h1>
              <el-button type="danger" round size="large" class="button font-gxjh-demlight">{{
                $t("home.find")
              }}</el-button>
            </div>
            <p class="text-xl text-[#696969] leading-[2.5rem] pt-10 pb-10" data-aos="fade-right" data-aos-delay="500">
        ...
        <div class="grid gap-0 grid-cols-10 max-lg:grid-cols-1 max-lg:pt-0">
          ...
          <div class="col-span-3 text-black col-start-8 max-lg:col-span-1 max-lg:col-start-1">
            <p class="text-xl text-[#696969] leading-[2.5rem] pt-10 pb-10" data-aos="fade-left" data-aos-delay="1000">
              高兴就好，作为中国成立最早、最具先锋的高校影像创造公司，自2014年成立以来，高兴就好 以“Shine Your
              Joy”为宗旨，始终专注高校影像赛道。
            </p>
          </div>
