...
`;
    ...
    function getFileType(fileName) {
        ...
        if (fileExtension in { 'jpg': true, 'jpeg': true, 'png': true, 'gif': true }) {
            return 'image';
        }
        else if (fileExtension in { 'mp4': true, 'avi': true, 'mov': true, 'wmv': true }) {
            return 'video';
        }
        else {
            return void 0;
